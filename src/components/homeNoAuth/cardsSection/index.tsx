            ...
            <Container className="d-flex flex-wrap justify-content-center gap-4 pb-5">
                <div className={styles.card1}>
                    ...
                    <p className={styles.cardDescription}>
                        Onebitcode Black is the place for you to evolve. For this, you
                        will have access to advanced programming practices, technology
                        updates, and all the technical support you need to become a
                        programming senior.
                    </p>
                </div>
